...
Component.options.__file = "resources/assets/js/views/manager/services/services.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-56b8e06a", Component.options)
  } else {
    hotAPI.reload("data-v-56b8e06a", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        edit: function edit(id) {
            this.$router.replace('/manager/services/' + id + '/edit');
        },
        deleteServices: function deleteServices(id) {
            var _this = this;

            var token = localStorage.getItem('access_token');
            axios.delete('/api/manager/services/' + id + '/destroy?token=' + token).then(function (res) {
    ...
    mounted: function mounted() {
        ...
        axios.get('/api/manager/services?token=' + token).then(function (response) {
                    ...
                    [
                      ...
                      _c(
                        "b-button",
                        {
                          ...
                          on: {
                            click: function($event) {
                              _vm.deleteServices(props.row.id)
                            }
                          }
                        },
                        [
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-56b8e06a", module.exports)
  }
}
