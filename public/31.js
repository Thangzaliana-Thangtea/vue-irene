...
Component.options.__file = "resources/assets/js/views/manager/payscales/payscales.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2cad7f64", Component.options)
  } else {
    hotAPI.reload("data-v-2cad7f64", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        edit: function edit(id) {
            this.$router.push('/manager/payscales/' + id + '/edit');
        },
        deleteBranch: function deleteBranch(id) {
            var _this = this;

            var token = localStorage.getItem('access_token');
            axios.delete('/api/manager/payscales/' + id + '/destroy?token=' + token).then(function (res) {
        ...
        fetchall: function fetchall() {
            ...
            var token = localStorage.getItem('access_token');
            axios.get('/api/manager/payscales?token=' + token).then(function (response) {
...
var render = function() {
  ...
  return _c(
    ...
    [
      _c("h4", [_vm._v(" List Of payscales")]),
      _vm._v(" "),
      _c("hr"),
      _vm._v(" "),
      _c("v-client-table", {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-2cad7f64", module.exports)
  }
}
