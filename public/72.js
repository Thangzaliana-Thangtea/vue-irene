...
Component.options.__file = "resources/assets/js/views/manager/categories/categories.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9754982c", Component.options)
  } else {
    hotAPI.reload("data-v-9754982c", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        edit: function edit(id) {
            this.$router.push('/manager/categories/' + id + '/edit');
        },
        deleteBranch: function deleteBranch(id) {
            var _this = this;

            var token = localStorage.getItem('access_token');
            axios.delete('/api/manager/categories/' + id + '/destroy?token=' + token).then(function (res) {
        ...
        fetchall: function fetchall() {
            ...
            var token = localStorage.getItem('access_token');
            axios.get('/api/manager/categories?token=' + token).then(function (response) {
...
var render = function() {
  ...
  return _c(
    "b-card",
    {
      ...
      attrs: { header: "List of category", "header-tag": "h4" }
    },
    [
      _c("v-client-table", {
        attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9754982c", module.exports)
  }
}
