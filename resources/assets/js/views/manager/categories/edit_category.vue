    ...
    <div class="app flex-row align-items-center">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <b-card variant="primary" header="Edit Category" header-tag="h4" footer-tag="footer">
                        <div>
    ...
    export  default{
        ...
        methods: {
            onSubmit: function (evt) {
                ...
                axios.put(`/api/manager/categories/${this.id}/update?token=${token}`, this.category)
                        .then(res=> {
                            this.clear();
                            this.$router.replace('/manager/categories')
                        })
                        .catch(err=> {
        ...
        mounted(){
            ...
            this.id = id;
            const token=localStorage.getItem('access_token')
            axios.get(`/api/manager/categories/${id}?token=${token}`)
                    .then(res=> {
                        console.log(res);
